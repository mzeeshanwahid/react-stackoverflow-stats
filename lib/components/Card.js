...
var Card = function (data) {
    ...
    return (react_1.default.createElement("div", { className: "card" },
        ...
        react_1.default.createElement("div", { className: "general" },
            react_1.default.createElement("h1", null, data.display_name),
            react_1.default.createElement("p", null, "Badges"),
            react_1.default.createElement("span", { className: "badge bronze" }, data.badge_counts.bronze),
            react_1.default.createElement("span", { className: "badge silver" }, data.badge_counts.silver),
            react_1.default.createElement("span", { className: "badge gold" }, data.badge_counts.gold),
            react_1.default.createElement("p", null, "Top Tags:"),
            data.tags.map(function (tag) { return (react_1.default.createElement("span", { className: "tag" }, tag)); }),
